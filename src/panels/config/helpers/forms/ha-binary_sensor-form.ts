...
class HaBinarySensorForm extends LitElement {
  ...
  @property() private _delay_on!: string | number | DurationDict;

  @property() private _delay_off!: string | number | DurationDict;
  ...
  set item(item: TemplateBinarySensor) {
    ...
    if (item) {
      ...
      this._delay_on = "00:00:00";
      this._delay_off = "00:00:00";
    }
  }
